...
server <- function(input, output, session) {
    ...
    page_navbar(
        ...
        tags$a(
          ...
          href = 
            if(is.null(query$data_set)){
              ...
              "http://127.0.0.1:8124/?page=home&data_set=GDC"
            }else if(query$data_set=="COSMIC"){
              "http://127.0.0.1:8124/?page=home&data_set=COSMIC"
            },
          title = ""
        )
      ),
      nav_item(
        tags$a(
          ...
          strong("Peptide Tool"),
          height = 40,
          href = "http://127.0.0.1:8124/?page=Peptide_Tool",
          title = ""
        )
      ),
      nav_spacer(),
        ...
        nav_menu(
          ...
          nav_item(
            tags$a(
              strong("NCI-GDC"),
              height = 40,
              href = "http://127.0.0.1:8124/?page=home&data_set=GDC",
              title = ""
            )
          ),
          nav_item(
            tags$a(
              strong("COSMIC"),
              height = 40,
              href = "http://127.0.0.1:8124/?page=home&data_set=COSMIC",
              title = ""
            )
          )
        )},
          ...
          mainPanel(
            ...
            fluidRow(
              layout_columns(
                ...
                card(
                  style = "border:none;",
                  actionButton(inputId = "GDC_dataset", 
                               label = h1("Go to NCI-GDC Dataset"),
                               style = 
                               "background-color:#2e3db0;padding:5px; 
                               border-radius: 10px 
                               !important; margin-right:5px;
                               height:400px;",
                               onclick ="location.href='http://127.0.0.1:8124/?page=home&data_set=GDC';")
                ),
                card(
                  style = "border:none;",
                  actionButton(inputId = "COSMIC_dataset", 
                               label = h1("Go to COSMIC Dataset"),
                               style = 
                               "background-color:#42c753;
                               padding:5px; border-radius: 10px 
                               !important; margin-right:5px;
                               height:400px;",
                               onclick ="location.href='http://127.0.0.1:8124/?page=home&data_set=COSMIC';")
                  )
              )
                ...
                layout_columns(
                  ...
                  card(
                    ...
                    card_header(h1(strong("QuavaProt")),
                                align = "center"),
                    card_body(
                      h3("Welcome to QuavaProt, a resource centered on predicting and 
  ...
  observeEvent(input$searchsubmit, {
    url = paste('http://127.0.0.1:8124/?page=results&query=', input$searchtext, 
