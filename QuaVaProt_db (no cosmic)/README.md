...
Download link: https://figshare.com/s/b771fef49397aab56ee7

This version of the app contains ONLY the NCI-GDC data sets for searching (COSMIC searching is disabled). 
